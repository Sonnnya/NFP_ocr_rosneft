...
- для подтверждения АО нужно, чтобы в пакете были все необходимые документы, а также чтобы строки в АО соответствовали данным в документах (например, строка "Проезд" в АО должна соответствовать документу "Проезд" с правильными датами и суммами, название может отличаься)
 
